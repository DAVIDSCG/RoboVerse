...
class Args:
    ...
    ## Others
    num_envs: int = 3  # GPU parallelism
    headless: bool = False
...
## Main loop
obs_saver = ObsSaver(video_path=f"get_started/output/david_scg_load_robot_assetc_{args.sim}.mp4")
obs_saver.add(obs)

step = 0
robot = scenario.robots[0]  # env[0]'s robot
for _ in range(100):
